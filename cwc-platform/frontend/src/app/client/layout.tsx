    ...
    <header className="bg-card/80 backdrop-blur-xl border-b border-border sticky top-0 z-50">
      <div className="max-w-5xl mx-auto px-6">
        <div className="flex justify-between items-center h-20">
          ...
          {/* Navigation */}
          <nav aria-label="Client portal navigation" className="flex items-center gap-1">
            {navItems.map((item) => {
              ...
              return (
                <Link
                  key={item.href}
                  href={item.href}
                  className={`px-4 py-1.5 text-sm font-medium transition-all rounded-full cursor-pointer ${
                    isActive
